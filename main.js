...
window.savePinjam = async function() {
    const anggotaId = currentUser.role === 'siswa' ? currentUser.id : document.getElementById('pinjam-anggota-id').value;
...
// Fungsi render (untuk oninput/onclick di HTML)
window.renderBuku = renderBuku;
window.renderAnggota = renderAnggota;
window.renderPinjam = renderPinjam;
window.renderKembali = renderKembali;
